...
//   <h3 className={[styles.h3, className].join('')} {...props}>
//     {...props}
//   </h3>
// );

// export const Heading4 = ({ children, className, ...props }) => (
//   <h4 className={[styles.h4, className].join('')} {...props}>
//     {...props}
//   </h4>
// );

// export const Heading5 = ({ children, className, ...props }) => (
//   <h5 className={[styles.h5, className].join('')} {...props}>
//     {...props}
//   </h5>
// );

// export const Heading6 = ({ children, className, ...props }) => (
//   <h6 className={[styles.h6, className].join('')} {...props}>
//     {...props}
//   </h6>
// );
